...
import static com.videorecorder.video.AudioFormatKeys.ByteOrderKey;
...
import static com.videorecorder.video.AudioFormatKeys.SignedKey;
...
import static com.videorecorder.video.VideoFormatKeys.ENCODING_AVI_DIB;
import static com.videorecorder.video.VideoFormatKeys.ENCODING_AVI_RLE;
...
import com.videorecorder.video.riff.RIFFChunk;
...
public class AVIOutputStream extends AbstractAVIStream {
     ...
     * than 1.
     */
    public int addVideoTrack(String fccHandler, long scale, long rate, int width, int height, int depth, int syncInterval, int compressionLevel) throws IOException {
        ensureFinished();
    ...
    public int addAudioTrack(int waveFormatTag, //
        ...
        t.format = new Format(MediaTypeKey, FormatKeys.MediaType.AUDIO,
            MimeTypeKey, MIME_AVI,
