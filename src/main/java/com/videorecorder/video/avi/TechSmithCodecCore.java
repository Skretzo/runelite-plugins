...
import com.videorecorder.video.AbstractVideoCodecCore;
...
public class TechSmithCodecCore extends AbstractVideoCodecCore {
     ...
     * @param scanlineStride The number to add to offset to get to the next scanline.
     */
    public void encodeDelta8to24(OutputStream out, byte[] data, byte[] prev, int width, int height, int offset, int scanlineStride, int compressionLevel)
            throws IOException {
     ...
     * @throws IOException 
     */
    public void encodeSameDelta8(OutputStream out, byte[] data, byte[] prev, int width, int height, int offset, int scanlineStride, int compressionLevel)
            throws IOException {
        /*
        temp.clear();temp.setByteOrder(ByteOrder.LITTLE_ENDIAN);
        temp.write(0); // Escape code
     ...
     * @throws IOException 
     */
    public void encodeSameDelta24(OutputStream out, int[] data, int[] prev, int width, int height, int offset, int scanlineStride, int compressionLevel)
            throws IOException {
        /*
        temp.clear();temp.setByteOrder(ByteOrder.LITTLE_ENDIAN);
     ...
     * @throws IOException 
     */
    public void encodeSameDelta16(OutputStream out, short[] data, short[] prev, int width, int height, int offset, int scanlineStride, int compressionLevel)
            throws IOException {
        /*
        temp.clear();temp.setByteOrder(ByteOrder.LITTLE_ENDIAN);
        temp.write(0); // Escape code
     ...
     * @param scanlineStride The number to add to offset to get to the next scanline.
     */
    public void encodeKey8to24(OutputStream out, byte[] data, int width, int height, int offset, int scanlineStride, int compressionLevel)
            throws IOException {
        temp.clear();temp.setByteOrder(ByteOrder.LITTLE_ENDIAN);
        int ymax = offset + height * scanlineStride;
        int upsideDown = ymax - scanlineStride + offset;
