...
import com.videorecorder.video.AbstractVideoCodec;
...
import static com.videorecorder.video.BufferFlag.SAME_DATA;
...
public class TechSmithCodec extends AbstractVideoCodec {
    ...
    protected static final Integer DEFAULT_COMPRESSION_LEVEL = 6;
    ...
    public TechSmithCodec() {
        super(
            new Format[] {
                new Format(MediaTypeKey, FormatKeys.MediaType.VIDEO, MimeTypeKey, MIME_AVI,
            ...
            switch (outputFormat.get(DepthKey)) {
                case 8: {
                    ...
                    if (isKeyframe) {
                        ...
                        if (in.isFlag(SAME_DATA)) {
                            state.encodeSameDelta8(tmp, pixels, (byte[]) previousPixels, outputFormat.get(WidthKey), outputFormat.get(HeightKey),
                                offset, scanlineStride, outputFormat.get(CompressionLevelKey, DEFAULT_COMPRESSION_LEVEL));
                        } else {
                ...
                case 16: {
                    ...
                    if (isKeyframe) {
                        ...
                        if (in.isFlag(SAME_DATA)) {
                            state.encodeSameDelta16(tmp, pixels, (short[]) previousPixels, outputFormat.get(WidthKey), outputFormat.get(HeightKey),
                                offset, scanlineStride, outputFormat.get(CompressionLevelKey, DEFAULT_COMPRESSION_LEVEL));
                        } else {
                ...
                case 24: {
                    ...
                    if (isKeyframe) {
                        ...
                        if (in.isFlag(SAME_DATA)) {
                            state.encodeSameDelta24(tmp, pixels, (int[]) previousPixels, outputFormat.get(WidthKey), outputFormat.get(HeightKey),
                                offset, scanlineStride, outputFormat.get(CompressionLevelKey, DEFAULT_COMPRESSION_LEVEL));
                        } else {
