...
import static com.videorecorder.video.AudioFormatKeys.ChannelsKey;
import static com.videorecorder.video.AudioFormatKeys.ENCODING_ALAW;
import static com.videorecorder.video.AudioFormatKeys.ENCODING_MP3;
import static com.videorecorder.video.AudioFormatKeys.ENCODING_PCM_SIGNED;
import static com.videorecorder.video.AudioFormatKeys.ENCODING_PCM_UNSIGNED;
import static com.videorecorder.video.AudioFormatKeys.ENCODING_ULAW;
import static com.videorecorder.video.AudioFormatKeys.FrameSizeKey;
import static com.videorecorder.video.AudioFormatKeys.SampleRateKey;
import static com.videorecorder.video.AudioFormatKeys.SampleSizeInBitsKey;
import com.videorecorder.video.Buffer;
import com.videorecorder.video.BufferFlag;
import static com.videorecorder.video.BufferFlag.DISCARD;
import static com.videorecorder.video.BufferFlag.KEYFRAME;
import com.videorecorder.video.io.ByteArrayImageOutputStream;
import com.videorecorder.video.Codec;
...
import com.videorecorder.video.MovieWriter;
import com.videorecorder.video.math.Rational;
import com.videorecorder.video.Registry;
import static com.videorecorder.video.VideoFormatKeys.CompressionLevelKey;
import static com.videorecorder.video.VideoFormatKeys.DataClassKey;
...
import static com.videorecorder.video.VideoFormatKeys.FixedFrameRateKey;
import static com.videorecorder.video.VideoFormatKeys.HeightKey;
import static com.videorecorder.video.VideoFormatKeys.QualityKey;
import static com.videorecorder.video.VideoFormatKeys.WidthKey;
import com.videorecorder.video.riff.RIFFParser;
import java.io.File;
...
public class AVIWriter extends AVIOutputStream implements MovieWriter {
    ...
    public final static Format VIDEO_RAW = new Format(
            MediaTypeKey, FormatKeys.MediaType.VIDEO, MimeTypeKey, MIME_AVI,
    ...
    */
    ...
    public int addTrack(Format format) throws IOException {
        if (format.get(MediaTypeKey) == FormatKeys.MediaType.VIDEO) {
    ...
    private int addVideoTrack(Format vf) throws IOException {
        ...
        int tr = addVideoTrack(
            vf.get(EncodingKey),
            vf.get(FrameRateKey).getDenominator(),
            vf.get(FrameRateKey).getNumerator(),
            vf.get(WidthKey),
            vf.get(HeightKey),
            vf.get(DepthKey),
